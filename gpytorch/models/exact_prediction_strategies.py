...
class DefaultPredictionStrategy(object):
    ...
    def _exact_predictive_covar_inv_quad_form_cache(self, train_train_covar_inv_root, test_train_covar):
        """
        Computes a cache for K_X*X (K_XX + sigma^2 I)^-1 K_X*X if possible. By default, this does not work and
    ...
    def _exact_predictive_covar_inv_quad_form_root(self, precomputed_cache, test_train_covar):
        r"""
        Computes :math:`K_{X_*, X} S` given a precomputed cache
        ...
        Returns
            :obj:`~linear_operator.operators.LinearOperator`: :math:`K_{X_*, X} S`
        """
...
class SparseComputationAwarePredictionStrategy(DefaultPredictionStrategy):
    """A Gaussian process prediction strategy which considers the performed computation."""
