...
from .exact_prediction_strategies import (
    ComputationAwarePredictionStrategy,
    SparseComputationAwarePredictionStrategy,
)
...
class ComputationAwareGP(ExactGP):
    ...
    def __init__(self, train_inputs, train_targets, likelihood, linear_solver: LinearSolver):
...
class SparseComputationAwareGP(ExactGP):
    """Computation-aware Gaussian processes.
    ...
    def __call__(self, *args, **kwargs):
        ...
        # Posterior mode
            ...
            if self.prediction_strategy is None:
                ...
                # Create the prediction strategy for
                self.prediction_strategy = SparseComputationAwarePredictionStrategy(
                    train_inputs=train_inputs,
                    train_prior_dist=train_output,
                    train_labels=self.train_targets,
                    likelihood=self.likelihood,
